...
void CoreChecks::TransitionImageLayouts(CMD_BUFFER_STATE *cb_state, uint32_t memBarrierCount,
    ...
    for (uint32_t i = 0; i < memBarrierCount; ++i) {
        ...
        RecordTransmitImageLayout(cb_state, image_state, *mem_barrier);
...
void CoreChecks::RecordTransmitImageLayout(CMD_BUFFER_STATE *cb_state, const IMAGE_STATE *image_state,
